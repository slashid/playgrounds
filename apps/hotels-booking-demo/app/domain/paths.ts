...
export const DETAILS_PATH = `${CHECKOUT_PATH}/details` as const;
...
export const BOOK_NOW_API_PATH = "/book-now";
...
export function isAnyCheckoutPage(pathname: string) {
  return pathname.startsWith(CHECKOUT_PATH);
}
