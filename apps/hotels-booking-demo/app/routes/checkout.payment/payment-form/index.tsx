...
export function PaymentForm() {
  ...
  const optimisticEmail = useOptimisticEmail();
  ...
  const [email, setEmail] = useState(optimisticEmail);
    ...
    fetcher.submit(
      {
        ...
        email: isLoggedIn ? playgroundEmail : email,
        // actionLog: stringify(
  ...
  return (
    <Form
      ...
      fields={mapPaymentDetailsToFormFields(
