...
import FormCustomisation from "../form-customisation";
...
const checkoutCTAPanelHandler: ContentHandler = {
  ...
  test: or(
    ...
    and(isInCheckoutPaymentPage, isUserLoggedIn, hasNoPaymentDetails)
  ),
...
const jwtToken: ContentHandler = {
  id: "jwt-token",
  test: isUserLoggedIn,
  content: <JWTToken />,
};

const formCustomisation: ContentHandler = {
  id: "form-customisation",
  test: isInLoginPage,
  content: <FormCustomisation />,
};

const impersonation: ContentHandler = {
  id: "impersonation",
  test: () => true,
  content: <ImpersonationPanel />,
};
