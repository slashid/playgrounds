...
export const SlashID: React.FC<Props> = ({
  className,
  slashFill = publicVariables.color.primary,
  idFill = publicVariables.color.foreground,
}) => (
  <svg
    className={className}
    width="40"
  ...
  >
    <path d="M12.686 10L2 30.228H5.198L15.884 10H12.686Z" fill={slashFill} />
    <path
