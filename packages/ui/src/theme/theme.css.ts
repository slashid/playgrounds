...
export const publicVariables = createGlobalThemeContract(
  {
    color: {
      ...
      smooth: "color-smooth",
      positiveSmooth: "color-positive-smooth",
      subtle: "color-subtle",
      soft: "color-soft",
      offset: "color-offset",
      colorfulStroke: "color-colorful-stroke",
      floating: "color-floating",
      primary: "color-primary",
      primary300: "color-primary-300",
      primaryStroke: "color-primary-stroke",
...
export const lightThemeColors = {
  ...
  positiveSmooth: colors.green100,
  subtle: "rgba(20, 32, 73, 0.06)",
  soft: "rgba(20, 32, 73, 0.04)",
  offset: "rgba(20, 32, 73, 0.01)",
  colorfulStroke: colors.blue800,
  floating: colors.grey200,
  primary: colors.blue500,
  primary300: colors.blue1000,
  primaryStroke: colors.blue600,
...
// default: light theme
createGlobalTheme(`.${classNames.root}`, publicVariables, lightTheme);
...
export const [themeClass, theme] = createTheme({
  ...
  boxShadow: {
    shadow100: "0px 4px 8px rgba(29, 25, 77, 0.02)",
    shadow200: "0px 12px 24px rgba(29, 25, 77, 0.1)",
    shadow300: "0px 12px 24px rgba(0, 0, 0, .12)",
    shadow400: "0px 12px 24px 0px rgba(29, 25, 77, 0.03)",
  },
  linearGradient: {
    gradient100: `linear-gradient(0deg, rgba(15, 14, 27, 0.8), rgba(15, 14, 27, 0.8)), ${publicVariables.color.primary}`,
  },
});
